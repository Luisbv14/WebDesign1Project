    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <table style="width: 100%;">
              <tr>
                  <td><asp:Literal ID="ltrCodigoMant" Text="Codigo Sobre" runat="server" /></td>
              ...
              <tr>
                  <td><asp:Literal Text="Frecuencia" runat="server" /></td>
                  <td> <asp:DropDownList ID="ddlFrecuencia"  CssClass="form-control" runat="server">
              ...
              <tr>
                  <td><asp:Literal ID="ltrFechaHoraFinal" Text="Fecha Final" runat="server" /></td>
                  <td><asp:TextBox TextMode="DateTimeLocal" ID="txtFechaHoraFinal" runat="server" CssClass="form-control" /></td>
              <td><asp:RequiredFieldValidator ID="rfvFechaHoraFinal" runat="server"
