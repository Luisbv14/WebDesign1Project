        ...
        <div id="myModal" class="modal">
            <form class="modal-content animate" runat="server">
                ...
                <div class="container">
                    ...
                    <asp:RequiredFieldValidator ID="rfqvUsername" runat="server" ErrorMessage="El nombre de usuario es requerido" ControlToValidate="txtUsername" ForeColor="Maroon"></asp:RequiredFieldValidator>
                    <asp:TextBox ID="txtPassword" TextMode="Password" runat="server" Placeholder="Ingrese su clave"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfqvPassword" runat="server" ErrorMessage="El password es requerido" ControlToValidate="txtPassword" ForeColor="Maroon" ></asp:RequiredFieldValidator>
