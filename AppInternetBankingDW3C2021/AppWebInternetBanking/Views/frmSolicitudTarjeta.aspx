...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <h1>Mantenimiento de solicitud tarjetas</h1>
    ...
    <asp:GridView ID="gvSolicitudTarjeta" runat="server" AutoGenerateColumns="false"
      CssClass="table table-sm" HeaderStyle-CssClass="thead-dark" 
        ...
        <Columns>
            <asp:BoundField HeaderText="CodigoSolicitud" DataField="CodigoSolicitud" />
            <asp:BoundField HeaderText="CodigoUsuario" DataField="CodigoUsuario" />
            <asp:BoundField HeaderText="Descripcion" DataField="Descripcion" />
            <asp:BoundField HeaderText="FechaHora" DataField="FechaHora" />
          ...
          <table style="width: 100%;">
              ...
              <tr>
                 ...
                 <td> <asp:DropDownList ID="ddlDescripcion"  CssClass="form-control" runat="server">
                    ...
                    <asp:ListItem Value="Tarjeta de debito">Tarjeta de debito</asp:ListItem>   
                </asp:DropDownList></td>
              </tr>

              <tr>
                  <td><asp:Literal ID="ltrFechaHora" Text="Fecha cita" runat="server" /></td>
