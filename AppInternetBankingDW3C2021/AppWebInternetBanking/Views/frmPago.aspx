...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gvPagos" runat="server" AutoGenerateColumns="false"
      CssClass="table table-sm" HeaderStyle-CssClass="thead-dark" 
        ...
        AlternatingRowStyle-BackColor="LightBlue" OnRowCommand="gvPagos_RowCommand" >
        <Columns>
      ...
      <div class="modal-body">
          <table style="width: 100%;">
              ...
              <tr>
                  ...
                  <td><asp:TextBox ID="txtCodigoServicio" runat="server" CssClass="form-control" /></td>

              </tr>
              <tr>
                  <td><asp:Literal ID="ltrCodigoCuenta" Text="Codigo Cuenta" runat="server" /></td>
                  <td><asp:TextBox ID="txtCodigoCuenta" runat="server" CssClass="form-control" /></td>
              </tr>
              <tr>
